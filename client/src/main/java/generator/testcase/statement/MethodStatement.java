		...
		try {
			return super.exceptionHandler(new Executer() {
				...
				public void execute() throws InvocationTargetException,
					...
					try {
						...
						for (int i = 0; i < parameters.size(); i++) {
							...
							if (inputs[i] != null) {
								...
								throw new CodeUnderTestException(null);
							}
						}
					...
					Object ret = null;//method.getMethod().invoke(callee_object, inputs);
					// Try exact return type
					/*
					 * TODO: Sometimes we do want to cast an Object to String etc...
					 */ 
					if (method.getReturnType().getClass() instanceof Class<?>) {
						Class<?> returnClass = (Class<?>)method.getReturnType().getClass();
